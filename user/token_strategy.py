...
from fastapi_users.authentication import RedisStrategy, Strategy
...
def get_jwt_strategy(
    ...
    strat = JWTStrategy[User_DB, int](secret=secret, lifetime_seconds=JWT_TOKEN_LIFETIME_SECONDS)
    return strat
