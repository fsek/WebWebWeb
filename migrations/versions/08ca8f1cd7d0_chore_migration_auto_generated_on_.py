...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["election_post_id"],
            ["election_post_table.election_post_id"],
        ),
        sa.ForeignKeyConstraint(
            ["post_id"],
            ["post_table.id"],
        ...
        sa.ForeignKeyConstraint(
            ["sub_election_id"],
            ["sub_election_table.sub_election_id"],
        ),
        sa.PrimaryKeyConstraint("nomination_id"),
    )
    op.add_column("candidate_table", sa.Column("sub_election_id", sa.Integer(), nullable=False, server_default="1"))
    ...
    op.add_column("candidations_table", sa.Column("sub_election_id", sa.Integer(), nullable=False, server_default="1"))
    op.add_column("candidations_table", sa.Column("post_id", sa.Integer(), nullable=False, server_default="1"))
    op.add_column(
        "candidations_table",
    ...
    op.add_column("election_post_table", sa.Column("sub_election_id", sa.Integer(), nullable=False, server_default="1"))
    op.add_column(
        "election_post_table", sa.Column("candidation_count", sa.Integer(), nullable=False, server_default="0")
    )
    ...
    op.add_column("election_table", sa.Column("title_sv", sa.String(length=100), nullable=False, server_default="1"))
    op.add_column("election_table", sa.Column("title_en", sa.String(length=100), nullable=False, server_default="1"))
    op.add_column("election_table", sa.Column("visible", sa.Boolean(), nullable=False, server_default="1"))
    ...
    op.add_column(
        "post_table",
        sa.Column("elected_at_semester", sa.Enum("HT", "VT", "HT and VT", "Other", native_enum=False), nullable=True),
    )
    op.add_column(
        "post_table",
        sa.Column(
            "elected_by",
            sa.Enum("Guild", "Board", "Educational Council", "Board Intermediate", "Other", native_enum=False),
            nullable=True,
        ),
    )
    op.add_column(
        "post_table", sa.Column("elected_user_recommended_limit", sa.Integer(), nullable=False, server_default="0")
    )
    op.add_column("post_table", sa.Column("elected_user_max_limit", sa.Integer(), nullable=False, server_default="0"))
...
def downgrade() -> None:
    ...
    op.add_column(
        "election_table", sa.Column("description", sa.VARCHAR(length=5000), autoincrement=False, nullable=True)
    )
    op.add_column(
        "election_table",
    ...
    op.create_foreign_key(
        "election_post_table_election_id_fkey",
        "election_post_table",
        "election_table",
        ["election_id"],
        ["election_id"],
    ...
    op.create_foreign_key(
        "candidate_table_election_id_fkey", "candidate_table", "election_table", ["election_id"], ["election_id"]
    )
