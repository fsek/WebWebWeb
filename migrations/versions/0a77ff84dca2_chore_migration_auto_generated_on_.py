...
def upgrade() -> None:
    ...
    op.add_column('user_table', sa.Column('moose_game_name', sa.String(), nullable=False))
    op.add_column('user_table', sa.Column('moose_game_score', sa.Integer(), nullable=False))
